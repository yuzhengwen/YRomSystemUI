...
# instance fields
.field private mAllowAlarm:Z

.field private mAllowAlarmSwitch:Landroid/widget/Switch;

.field private mAllowExceptionsSwitch:Landroid/widget/Switch;
...
.field private mZenSwitchPosition:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v3, p0, v7}, Lcom/android/systemui/volume/ZenModePanel$H;-><init>(Lcom/android/systemui/volume/ZenModePanel;Lcom/android/systemui/volume/ZenModePanel$1;)V
    ...
    invoke-direct {v3, p0, v7}, Lcom/android/systemui/volume/ZenModePanel$TransitionHelper;-><init>(Lcom/android/systemui/volume/ZenModePanel;Lcom/android/systemui/volume/ZenModePanel$1;)V
    ...
    iput-boolean v5, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSwitchPosition:Z
    ...
    new-instance v3, Lcom/android/systemui/volume/ZenModePanel$12;

    invoke-direct {v3, p0}, Lcom/android/systemui/volume/ZenModePanel$12;-><init>(Lcom/android/systemui/volume/ZenModePanel;)V
    ...
    new-instance v3, Lcom/android/systemui/volume/ZenModePanel$13;

    invoke-direct {v3, p0}, Lcom/android/systemui/volume/ZenModePanel$13;-><init>(Lcom/android/systemui/volume/ZenModePanel;)V
    ...
    invoke-direct {v3, p0, v7}, Lcom/android/systemui/volume/ZenModePanel$Prefs;-><init>(Lcom/android/systemui/volume/ZenModePanel;Lcom/android/systemui/volume/ZenModePanel$1;)V
    ...
    iget-object v6, p0, Lcom/android/systemui/volume/ZenModePanel;->mContext:Landroid/content/Context;

    invoke-direct {v3, v6}, Lcom/android/systemui/volume/IconPulser;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/volume/ZenModePanel;->getContext()Landroid/content/Context;
    ...
    const-string v6, "somc.zen_alarm"
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowAlarm:Z
    ...
    invoke-virtual {v3, v6}, Landroid/app/NotificationManager;->isSystemConditionProviderEnabled(Ljava/lang/String;)Z
...
.method static synthetic access$1700(Lcom/android/systemui/volume/ZenModePanel;)Lcom/android/systemui/volume/ZenModePanel$H;
    .locals 1
...
.method static synthetic access$2000(Lcom/android/systemui/volume/ZenModePanel;I)V
    .locals 0
...
.method static synthetic access$400(Lcom/android/systemui/volume/ZenModePanel;)Lcom/android/systemui/statusbar/policy/ZenModeController;
    .locals 1
...
.method static synthetic access$502(Lcom/android/systemui/volume/ZenModePanel;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSwitchPosition:Z

    return p1
.end method

.method static synthetic access$600(Lcom/android/systemui/volume/ZenModePanel;)V
    .locals 0
...
.method static synthetic access$700(Lcom/android/systemui/volume/ZenModePanel;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/systemui/volume/ZenModePanel;->setAlarmSwitchStatus(Z)V
...
.method private announceConditionSelection(Lcom/android/systemui/volume/ZenModePanel$ConditionTag;)V
    ...
    :pswitch_1
    invoke-direct {p0}, Lcom/android/systemui/volume/ZenModePanel;->getAlarmSwitchStatus()Z
...
.method private getAlarmSwitchStatus()Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowAlarm:Z
...
.method private handleUpdateZen(I)V
    ...
    :goto_0
    invoke-virtual {p0, v2}, Lcom/android/systemui/volume/ZenModePanel;->setExpanded(Z)V
    ...
    invoke-virtual {v2, v5}, Lcom/android/systemui/volume/SegmentedButtons;->setSelectedValue(Ljava/lang/Object;)V
    ...
    :goto_1
    iget-object v2, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowExceptionsSwitch:Landroid/widget/Switch;

    invoke-virtual {v2, v1}, Landroid/widget/Switch;->setSelected(Z)V
...
.method private refreshPanelTexts()V
    .locals 2

    iget-object v0, p0, Lcom/android/systemui/volume/ZenModePanel;->mTitle:Landroid/widget/TextView;

    const v1, 0x7f0d0029

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(I)V

    iget-object v0, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowExceptionsSwitch:Landroid/widget/Switch;

    const v1, 0x7f0d002b

    invoke-virtual {v0, v1}, Landroid/widget/Switch;->setText(I)V

    iget-object v0, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowAlarmSwitch:Landroid/widget/Switch;
...
.method private select(Landroid/service/notification/Condition;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Lcom/android/systemui/volume/ZenModePanel$10;-><init>(Lcom/android/systemui/volume/ZenModePanel;ZLandroid/service/notification/Condition;)V
...
.method private setAlarmSwitchStatus(Z)V
    .locals 3
    ...
    :cond_0
    iput-boolean p1, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowAlarm:Z
    ...
    const-string v2, "somc.zen_alarm"
...
.method private updateWidgets()V
    ...
    iget-object v5, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowExceptionsSwitch:Landroid/widget/Switch;

    iget-boolean v8, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSwitchPosition:Z

    invoke-virtual {v5, v8}, Landroid/widget/Switch;->setChecked(Z)V

    :goto_7
    iget-object v8, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenConditions:Landroid/widget/LinearLayout;
    ...
    iget-object v8, p0, Lcom/android/systemui/volume/ZenModePanel;->mTitle:Landroid/widget/TextView;
    ...
    iget-object v5, p0, Lcom/android/systemui/volume/ZenModePanel;->mDivider:Landroid/view/View;
...
.method public destroy()V
    ...
    iput-object v2, p0, Lcom/android/systemui/volume/ZenModePanel;->mController:Lcom/android/systemui/statusbar/policy/ZenModeController;

    :cond_0
    invoke-virtual {p0, v2}, Lcom/android/systemui/volume/ZenModePanel;->setCallback(Lcom/android/systemui/volume/ZenModePanel$Callback;)V
...
.method public isExceptionSwitchChecked()Z
    .locals 1
...
.method protected onFinishInflate()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/volume/ZenModePanel;->findViewById(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Lcom/android/systemui/volume/SegmentedButtons;

    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenButtons:Lcom/android/systemui/volume/SegmentedButtons;

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenButtons:Lcom/android/systemui/volume/SegmentedButtons;
    ...
    invoke-virtual {v3, v5, v6, v7}, Lcom/android/systemui/volume/SegmentedButtons;->addButton(IILjava/lang/Object;)V
    ...
    iget-object v5, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenButtonsCallback:Lcom/android/systemui/volume/SegmentedButtons$Callback;

    invoke-virtual {v3, v5}, Lcom/android/systemui/volume/SegmentedButtons;->setCallback(Lcom/android/systemui/volume/SegmentedButtons$Callback;)V

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenButtons:Lcom/android/systemui/volume/SegmentedButtons;

    const/16 v5, 0x8

    invoke-virtual {v3, v5}, Lcom/android/systemui/volume/SegmentedButtons;->setVisibility(I)V
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/volume/ZenModePanel;->newLayoutTransition(Landroid/animation/LayoutTransition$TransitionListener;)Landroid/animation/LayoutTransition;
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSubhead:Landroid/view/View;
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSubheadCollapsed:Landroid/widget/TextView;

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSubheadCollapsed:Landroid/widget/TextView;

    new-instance v5, Lcom/android/systemui/volume/ZenModePanel$1;

    invoke-direct {v5, p0}, Lcom/android/systemui/volume/ZenModePanel$1;-><init>(Lcom/android/systemui/volume/ZenModePanel;)V

    invoke-virtual {v3, v5}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSubheadCollapsed:Landroid/widget/TextView;

    iget-object v5, p0, Lcom/android/systemui/volume/ZenModePanel;->mInteractionCallback:Lcom/android/systemui/volume/Interaction$Callback;

    invoke-static {v3, v5}, Lcom/android/systemui/volume/Interaction;->register(Landroid/view/View;Lcom/android/systemui/volume/Interaction$Callback;)V
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSubheadExpanded:Landroid/widget/TextView;

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenSubheadExpanded:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mMoreSettings:Landroid/view/View;

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mMoreSettings:Landroid/view/View;

    new-instance v5, Lcom/android/systemui/volume/ZenModePanel$2;

    invoke-direct {v5, p0}, Lcom/android/systemui/volume/ZenModePanel$2;-><init>(Lcom/android/systemui/volume/ZenModePanel;)V
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mZenConditions:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/volume/ZenModePanel;->setLayoutTransition(Landroid/animation/LayoutTransition;)V
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mTitle:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowExceptionsSwitch:Landroid/widget/Switch;
    ...
    :goto_1
    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowExceptionsSwitch:Landroid/widget/Switch;

    invoke-virtual {v3, v2}, Landroid/widget/Switch;->setChecked(Z)V

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowExceptionsSwitch:Landroid/widget/Switch;

    new-instance v4, Lcom/android/systemui/volume/ZenModePanel$3;

    invoke-direct {v4, p0}, Lcom/android/systemui/volume/ZenModePanel$3;-><init>(Lcom/android/systemui/volume/ZenModePanel;)V
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowAlarmSwitch:Landroid/widget/Switch;

    iget-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mAllowAlarmSwitch:Landroid/widget/Switch;
    ...
    new-instance v4, Lcom/android/systemui/volume/ZenModePanel$4;

    invoke-direct {v4, p0}, Lcom/android/systemui/volume/ZenModePanel$4;-><init>(Lcom/android/systemui/volume/ZenModePanel;)V
    ...
    iput-object v3, p0, Lcom/android/systemui/volume/ZenModePanel;->mDivider:Landroid/view/View;
...
.method protected setExpanded(Z)V
    .locals 1
...
.method public updateLocale()V
    ...
    invoke-direct {p0}, Lcom/android/systemui/volume/ZenModePanel;->refreshPanelTexts()V
