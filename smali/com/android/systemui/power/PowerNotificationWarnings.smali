...
# instance fields
.field mBatteryFullSound:Ljava/lang/String;
...
.field mFullBatteryVibrationPattern:[J

.field private final mHandler:Landroid/os/Handler;

.field private mInvalidCharger:Z

.field mLowBatteryVibrationPattern:[J
...
.field private final mOpenStaminaMode:Landroid/content/Intent;

.field private final mPlayHandler:Landroid/os/Handler;

.field private mPlaySound:Z

.field mPlugVibrationPattern:[J

.field mPluggedInSound:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V
    ...
    const-string v0, "com.sonymobile.intent.action.STAMINA_SETTINGS"

    invoke-static {v0}, Lcom/android/systemui/power/PowerNotificationWarnings;->settings(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mOpenStaminaMode:Landroid/content/Intent;

    const-string v0, "com.sonymobile.intent.action.POWER_SETTINGS"
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/systemui/power/PowerNotificationWarnings$1;-><init>(Lcom/android/systemui/power/PowerNotificationWarnings;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPlayHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/systemui/power/PowerNotificationWarnings$7;

    invoke-direct {v0, p0}, Lcom/android/systemui/power/PowerNotificationWarnings$7;-><init>(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/systemui/power/PowerNotificationWarnings;->toLongArray([I)[J

    move-result-object v0

    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mLowBatteryVibrationPattern:[J
    ...
    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mFullBatteryVibrationPattern:[J
    ...
    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPlugVibrationPattern:[J
    ...
    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mBatteryFullSound:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPluggedInSound:Ljava/lang/String;
...
.method static synthetic access$100(Lcom/android/systemui/power/PowerNotificationWarnings;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/systemui/power/PowerNotificationWarnings;->playSound(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$1000(Lcom/android/systemui/power/PowerNotificationWarnings;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/systemui/power/PowerNotificationWarnings;)Landroid/content/Intent;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/systemui/power/PowerNotificationWarnings;)Landroid/content/Intent;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mOpenStaminaMode:Landroid/content/Intent;
...
.method static synthetic access$1600(Lcom/android/systemui/power/PowerNotificationWarnings;Z)V
    .locals 0
...
.method static synthetic access$200(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    .locals 0
...
.method static synthetic access$300(Lcom/android/systemui/power/PowerNotificationWarnings;)V
    .locals 0
...
.method static synthetic access$702(Lcom/android/systemui/power/PowerNotificationWarnings;Z)Z
    .locals 0
...
.method static synthetic access$802(Lcom/android/systemui/power/PowerNotificationWarnings;Lcom/android/systemui/statusbar/phone/SystemUIDialog;)Lcom/android/systemui/statusbar/phone/SystemUIDialog;
    .locals 0
...
.method private attachLowBatterySound(Landroid/app/Notification$Builder;)V
    ...
    const-string v8, "low_battery_sound_timeout"

    const/4 v9, 0x0

    invoke-static {v1, v8, v9}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    const-string v10, "screen off too long ("
    ...
    const-string v10, "ms): not waking up the user with low battery sound"
    ...
    const-string v9, "playing low battery sound. pick-a-doop!"
    ...
    iget-object v8, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mLowBatteryVibrationPattern:[J

    invoke-direct {p0, v8}, Lcom/android/systemui/power/PowerNotificationWarnings;->vibrate([J)V
    ...
    invoke-static {v1, v8, v12}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-virtual {p1, v7, v8}, Landroid/app/Notification$Builder;->setSound(Landroid/net/Uri;Landroid/media/AudioAttributes;)Landroid/app/Notification$Builder;
...
.method private checkStaminaEnabled()V
    ...
    new-instance v0, Lcom/android/systemui/power/PowerNotificationWarnings$4;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/systemui/power/PowerNotificationWarnings$4;-><init>(Lcom/android/systemui/power/PowerNotificationWarnings;Landroid/content/ContentResolver;)V
...
.method private playSound(Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/android/systemui/power/PowerNotificationWarnings;->isMainThread()Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v3, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPlayHandler:Landroid/os/Handler;
...
.method private showWarningNotification()V
    ...
    invoke-virtual {v7, v14, v8}, Landroid/content/Context;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v13}, Landroid/app/Notification$Builder;->setOnlyAlertOnce(Z)Landroid/app/Notification$Builder;
    ...
    iget-boolean v6, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mUsmEnabled:Z
    ...
    :cond_0
    iget-boolean v6, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mStaminaEnabled:Z
    ...
    invoke-virtual {v6, v14, v7}, Landroid/content/Context;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string v7, "PNW.startStaminaMode"

    invoke-direct {p0, v7}, Lcom/android/systemui/power/PowerNotificationWarnings;->pendingBroadcast(Ljava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v7

    invoke-virtual {v3, v12, v6, v7}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/power/PowerNotificationWarnings;->attachLowBatterySound(Landroid/app/Notification$Builder;)V

    iput-boolean v12, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPlaySound:Z
    ...
    iget-object v6, v2, Landroid/app/Notification;->headsUpContentView:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v6, v7, v8, v2, v9}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V

    return-void
.end method

.method private toLongArray([I)[J
    .locals 4
...
.method public playBatteryChargedSound()V
    .locals 6
    ...
    const-string v4, "playing battery charged sound"
    ...
    const-string v3, "somc.battery_charged_sound_enabled"
    ...
    iget-object v3, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mFullBatteryVibrationPattern:[J

    invoke-direct {p0, v3}, Lcom/android/systemui/power/PowerNotificationWarnings;->vibrate([J)V
    ...
    iget-object v3, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mBatteryFullSound:Ljava/lang/String;

    invoke-direct {p0, v3}, Lcom/android/systemui/power/PowerNotificationWarnings;->playSound(Ljava/lang/String;)V

    goto :goto_0
.end method

.method public playPluggedInSound()V
    .locals 6
    ...
    const-string v4, "playing charger plugged in sound"
    ...
    iget-object v3, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPlugVibrationPattern:[J
    ...
    iget-object v3, p0, Lcom/android/systemui/power/PowerNotificationWarnings;->mPluggedInSound:Ljava/lang/String;
